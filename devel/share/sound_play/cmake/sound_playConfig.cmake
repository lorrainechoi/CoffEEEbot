...
if("TRUE" STREQUAL "TRUE")
  set(sound_play_SOURCE_PREFIX /home/human/Desktop/catkin_ws/src/audio_common/sound_play)
  set(sound_play_DEVEL_PREFIX /home/human/Desktop/catkin_ws/devel)
  ...
  set(sound_play_INSTALL_PREFIX /home/human/Desktop/catkin_ws/install)
...
if(NOT "/home/human/Desktop/catkin_ws/devel/include;/home/human/Desktop/catkin_ws/src/audio_common/sound_play/include " STREQUAL " ")
  set(sound_play_INCLUDE_DIRS "")
  set(_include_dirs "/home/human/Desktop/catkin_ws/devel/include;/home/human/Desktop/catkin_ws/src/audio_common/sound_play/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sound_play' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'sound_play' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/human/Desktop/catkin_ws/src/audio_common/sound_play/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
...
set(sound_play_EXPORTED_TARGETS "sound_play_generate_messages_cpp;sound_play_generate_messages_lisp;sound_play_generate_messages_py")
