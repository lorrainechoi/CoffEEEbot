...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/human/Desktop/catkin_ws/src/state_machine)
  set(state_machine_DEVEL_PREFIX /home/human/Desktop/catkin_ws/devel)
  ...
  set(state_machine_INSTALL_PREFIX /home/human/Desktop/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'human <human@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/human/Desktop/catkin_ws/src/state_machine/${idir}'.  Ask the maintainer 'human <human@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${state_machine_dep}_FOUND)
      find_package(${state_machine_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${state_machine_dep} REQUIRED ${depend_list})
  endif()
